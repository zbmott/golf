...
Hole = BaseHole(
    ...
    collidibles=LayeredDirty(
        ...
        Green([Point(250, 540, 0), Point(530, 540, 0), Point(530, 610, 0), Point(250, 610, 0)]),
        Rough([Point(530, 540, 0), Point(610, 540, 0), Point(610, 610, 0), Point(530, 610, 0)]),
        Rough([Point(610, 660, 0), Point(610, 730, 0), Point(530, 730, 0), Point(530, 660, 0)]),
        Green([Point(530, 610, 0), Point(530, 660, 0), Point(610, 660, 0), Point(610, 610, 0)]),
        Green([Point(610, 730, 0), Point(610, 660, 0), Point(740, 660, 0), Point(740, 730, 0)]),
        Rough([Point(250, 540, 0), Point(250, 510, 0), Point(50, 510, 0), Point(50, 640, 0), Point(250, 640, 0)]),
        Lava([Point(500, 450, 0), Point(610, 450, 0), Point(740, 630, 0), Point(790, 630, 0), Point(640, 280, 0), Point(640, 230, 0), Point(970, 150, 0), Point(630, 150, 0), Point(630, 200, 0), Point(500, 200, 0)]),
        Water([Point(50, 450, 0), Point(50, 510, 0), Point(250, 510, 0), Point(250, 540, 0), Point(610, 540, 0), Point(610, 660, 0), Point(740, 660, 0), Point(740, 630, 0), Point(610, 450, 0), Point(50, 450, 0)]),
        Lava([Point(500, 50, 0), Point(530, 50, 0), Point(530, 200, 0), Point(500, 200, 0)]),
        Lava([Point(630, 50, 0), Point(1050, 50, 0), Point(1050, 100, 0), Point(630, 100, 0)]),
        Water([Point(960, 850, 0), Point(50, 850, 0), Point(50, 640, 0), Point(250, 640, 0), Point(250, 610, 0), Point(530, 610, 0), Point(530, 730, 0), Point(740, 730, 0), Point(740, 780, 0), Point(890, 780, 0)]),
        Water([Point(890, 780, 0), Point(890, 630, 0), Point(1050, 480, 0), Point(1050, 850, 0), Point(960, 850, 0)]),
        Lava([Point(890, 630, 0), Point(1050, 480, 0), Point(1050, 180, 0), Point(1020, 180, 0), Point(710, 260, 0), Point(860, 630, 0), Point(890, 630, 0)]),
        Pin(Point(840, 695, 0)),
        Tunnel(Point(340, 320, 0), Point(540, 120, 0), Vector2(2.5, 0.0)),
        Tunnel(Point(75, 425, 0), Point(70, 580, 0), Vector2(5.0, 0.0)),
