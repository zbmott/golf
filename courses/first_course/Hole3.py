...
Hole = BaseHole(
    ...
    collidibles=LayeredDirty(
        ...
        Slope(Point(50, 160, 0), Point(230, 220, 0), Color(100, 0, 0, 255), Vector2(0.0, -0.65)),
        Rough(Point(50, 110, 0), Point(230, 160, 0)),
        Green(Point(230, 290, 0), Point(800, 340, 0)),
        Slope(Point(280, 340, 0), Point(800, 410, 0), Color(100, 0, 0, 255), Vector2(-0.25, 0.65)),
        Slope(Point(280, 220, 0), Point(800, 290, 0), Color(100, 0, 0, 255), Vector2(-0.25, -0.65)),
        Sand(Point(280, 410, 0), Point(800, 470, 0)),
        Sand(Point(280, 160, 0), Point(800, 220, 0)),
